...
def build_vgg():
    ...
    vgg.outputs = [vgg.layers[52].output]
...
plt.figure()
plt.hist(features[0, :, :, 0], bins=20, normed=True, range=[0.2, 1.0])
plt.title('ResNet Image Histogram')
...
# plt.figure()
# plt.hist(res1_vgg)
# plt.title('ResNet Filtered Image Histogram')
# plt.show()